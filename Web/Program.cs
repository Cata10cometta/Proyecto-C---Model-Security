...
builder.Services.AddScoped<RolPermissionBusiness>();
...
builder.Services.AddScoped<ExperienceData>();
builder.Services.AddScoped<ExperienceBusiness>();

builder.Services.AddScoped<ExperienceLineThematicData>();
builder.Services.AddScoped<ExperienceLineThematicBusiness>();

builder.Services.AddScoped<ExperiencePopulationData>();
builder.Services.AddScoped<ExperiencePopulationBusiness>();

builder.Services.AddScoped<ExperienceGradeData>();
...
builder.Services.AddScoped<InstitutionData>();
builder.Services.AddScoped<InstitutionBusiness>();
