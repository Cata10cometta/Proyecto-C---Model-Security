...
-- --------------------------------------------------
-- Date Created: 04/03/2025 17:15:39
-- Generated from EDMX file: C:\Users\DELL\OneDrive\Desktop\ModelSecurityCata\Diagrama-Experiencia\ModelCata.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Experiencias] (
    ...
    [DateRegistration] nvarchar(max)  NOT NULL,
    [Code] nvarchar(max)  NOT NULL,
    [DeleteAt] datetime  NOT NULL,
    [CreateAt] datetime  NOT NULL,
    [UserId] int  NOT NULL,
...
-- Creating foreign key on [RolId1] in table 'Rol_Permisos'
ALTER TABLE [dbo].[Rol_Permisos]
ADD CONSTRAINT [FK_RolRol_Permiso]
    FOREIGN KEY ([RolId1])
...
-- Creating non-clustered index for FOREIGN KEY 'FK_RolRol_Permiso'
CREATE INDEX [IX_FK_RolRol_Permiso]
ON [dbo].[Rol_Permisos]
    ([RolId1]);
GO

-- Creating foreign key on [PermissionId1] in table 'Rol_Permisos'
ALTER TABLE [dbo].[Rol_Permisos]
ADD CONSTRAINT [FK_PermisoRol_Permiso]
    FOREIGN KEY ([PermissionId1])
    REFERENCES [dbo].[Permisos]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_PermisoRol_Permiso'
CREATE INDEX [IX_FK_PermisoRol_Permiso]
ON [dbo].[Rol_Permisos]
    ([PermissionId1]);
GO
...
ALTER TABLE [dbo].[Objectivos]
ADD CONSTRAINT [FK_ExperienciaObjectivo]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ExperienciaObjectivo'
CREATE INDEX [IX_FK_ExperienciaObjectivo]
ON [dbo].[Objectivos]
    ([ExperienceId]);
GO
...
-- Creating foreign key on [Person_Id] in table 'Usuarios'
ALTER TABLE [dbo].[Usuarios]
...
ALTER TABLE [dbo].[ExperienciaLineaTematicas]
ADD CONSTRAINT [FK_LineThematicExperienceLineThematic]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_LineThematicExperienceLineThematic'
CREATE INDEX [IX_FK_LineThematicExperienceLineThematic]
...
ALTER TABLE [dbo].[Historial_Experiencias]
ADD CONSTRAINT [FK_ExperienceHistoryExperience]
    FOREIGN KEY ([ExperienceId])
    REFERENCES [dbo].[Experiencias]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ExperienceHistoryExperience'
CREATE INDEX [IX_FK_ExperienceHistoryExperience]
ON [dbo].[Historial_Experiencias]
    ([ExperienceId]);
GO
...
-- Creating foreign key on [ExperienceId] in table 'Documentos'
ALTER TABLE [dbo].[Documentos]
ADD CONSTRAINT [FK_ExperienceDocument1]
    FOREIGN KEY ([ExperienceId])
    REFERENCES [dbo].[Experiencias]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ExperienceDocument1'
CREATE INDEX [IX_FK_ExperienceDocument1]
ON [dbo].[Documentos]
    ([ExperienceId]);
GO
...
ALTER TABLE [dbo].[Experiencias]
ADD CONSTRAINT [FK_ExperienceInstitution]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ExperienceInstitution'
CREATE INDEX [IX_FK_ExperienceInstitution]
ON [dbo].[Experiencias]
    ([InstitutionId]);
GO
